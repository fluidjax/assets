module github.com/qredo/assets/libs/clitools
...
require (
	...
	github.com/qredo/assets v0.0.0-20200115142334-d08f31d383d6
	github.com/tendermint/tendermint v0.33.1
	github.com/urfave/cli/v2 v2.1.1
)

replace github.com/qredo/assets => /Users/chris/dev/qredo/assets/
