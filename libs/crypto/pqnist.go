...
/*
#cgo CFLAGS:  -O2 -I/usr/local/include -I${SRCDIR}/libs/include
#cgo LDFLAGS: -L/usr/local/lib -L${SRCDIR}/libs -L. -lpqnist -lamcl_bls_BLS381 -lamcl_pairing_BLS381 -lamcl_curve_BLS381 -lamcl_core -loqs
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
// SIKE
const oqsKemSikeP751LengthPublicKey int = int(C.OQS_KEM_sike_length_public_key)
const oqsKemSikeP751LengthSecretKey int = int(C.OQS_KEM_sike_length_secret_key)
const oqsKemSikeP751LengthCiphertext int = int(C.OQS_KEM_sike_length_ciphertext)
