...
#ifdef SIKE_COMPRESS
#define ALG_NAME "SIKE-p751-compressed"
#define OQS_KEM_sike_length_public_key 334
#define OQS_KEM_sike_length_secret_key 413
#define OQS_KEM_sike_length_ciphertext 363
#define OQS_KEM_sike_length_shared_secret 32
#else
#define ALG_NAME "SIKE-p751"
#define OQS_KEM_sike_length_public_key 564
#define OQS_KEM_sike_length_secret_key 644
#define OQS_KEM_sike_length_ciphertext 596
#define OQS_KEM_sike_length_shared_secret 32
#endif
...
/**  @brief Sign a message
     ...
     @return             Zero for success or else an error code
 */
 int pqnist_bls_sign(char* m, int mlen, char* sk, char* S);
...
/**  @brief Verify a signature
     ...
     @return             Zero for success or else an error code
 */
 int pqnist_bls_verify(char* m, int mlen, char* pk, char* S);
